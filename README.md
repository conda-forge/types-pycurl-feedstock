...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-pycurl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13144&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-pycurl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-pycurl` can be installed with:

```
conda install types-pycurl
```

It is possible to list all of the versions of `types-pycurl` available on your platform with:
